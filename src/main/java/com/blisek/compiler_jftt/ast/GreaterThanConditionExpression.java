...
public class GreaterThanConditionExpression extends ConditionExpression {

	public GreaterThanConditionExpression(ValueExpression expr1, ValueExpression expr2) {
		super(expr1, expr2);
	}

	public GreaterThanConditionExpression(int label, ValueExpression expr1, ValueExpression expr2) {
