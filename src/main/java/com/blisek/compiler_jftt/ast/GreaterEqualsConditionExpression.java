...
public class GreaterEqualsConditionExpression extends ConditionExpression {

	public GreaterEqualsConditionExpression(ValueExpression expr1, ValueExpression expr2) {
		super(expr1, expr2);
	}

	public GreaterEqualsConditionExpression(int label, ValueExpression expr1, ValueExpression expr2) {
