...
public class LessThanConditionExpression extends ConditionExpression {

	public LessThanConditionExpression(ValueExpression expr1, ValueExpression expr2) {
		super(expr1, expr2);
	}

	public LessThanConditionExpression(int label, ValueExpression expr1, ValueExpression expr2) {
	...
	protected void writeComparison(Context ctx, int[] jumpLabels, RegisterReservationInfo[] reservedRegisters,
		...
		writer.write(OperationsHelper.genInstruction(Instructions.INC_i, firstReg));
