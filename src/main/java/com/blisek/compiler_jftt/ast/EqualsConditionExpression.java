...
public class EqualsConditionExpression extends ConditionExpression {
	...
	public EqualsConditionExpression(Expression expr1, Expression expr2) {
		super(expr1, expr2);
	}

	public EqualsConditionExpression(int label, Expression expr1, Expression expr2) {
	...
	protected void writeComparison(Context ctx, int[] jumpLabels, RegisterReservationInfo[] reservedRegisters,
		...
		final ValueExpression leftExp = (ValueExpression)getFirstExpression(), 
				rightExp = (ValueExpression)getSecondExpression();
